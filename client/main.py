...
tk.Radiobutton(window, text='get a student\'s information', variable=tk_method, value="get", command=None).pack()
...
tk.Radiobutton(window, text='update a student\'s information', variable=tk_method, value="update", command=None).pack()
# get Info
tk_id = tk.StringVar()
